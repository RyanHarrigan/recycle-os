...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\ImageuploadsRepository' => ['privates', 'App\\Repository\\ImageuploadsRepository', 'getImageuploadsRepositoryService', false],
            'App\\Repository\\RfTagsRepository' => ['privates', 'App\\Repository\\RfTagsRepository', 'getRfTagsRepositoryService', false],
            'App\\Repository\\UserPointsRepository' => ['privates', 'App\\Repository\\UserPointsRepository', 'getUserPointsRepositoryService', false],
        ], [
            'App\\Repository\\ImageuploadsRepository' => '?',
            'App\\Repository\\RfTagsRepository' => '?',
            'App\\Repository\\UserPointsRepository' => '?',
        ])));
    ...
    /**
     * Gets the private 'App\Repository\ImageuploadsRepository' shared autowired service.
     *
     * @return \App\Repository\ImageuploadsRepository
     */
    protected function getImageuploadsRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/ImageuploadsRepository.php';

        return $this->privates['App\\Repository\\ImageuploadsRepository'] = new \App\Repository\ImageuploadsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\RfTagsRepository' shared autowired service.
     *
     * @return \App\Repository\RfTagsRepository
     */
    protected function getRfTagsRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/RfTagsRepository.php';

        return $this->privates['App\\Repository\\RfTagsRepository'] = new \App\Repository\RfTagsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\UserPointsRepository' shared autowired service.
     *
     * @return \App\Repository\UserPointsRepository
     */
    protected function getUserPointsRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/UserPointsRepository.php';

        return $this->privates['App\\Repository\\UserPointsRepository'] = new \App\Repository\UserPointsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
